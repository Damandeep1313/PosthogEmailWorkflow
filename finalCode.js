//this is modified version of fastestLogic.js with posthog key as userdefined
...
if (!apiKey || apiKey.trim() === "") {
  console.log("Missing or empty API key detected");
  return sendErrorResponse(res, 401, "PostHog API key is missing", {
    action: "Please provide a valid API key in the 'x-posthog-api-key' header.",
  });
}
